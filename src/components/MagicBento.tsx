...
const DEFAULT_GLOW_COLOR = '66, 133, 244'; // Google Blue
        ...
        {items.map((card, index) => {
          ...
          const CardContent = (
            <>
              ...
              {card.icon && (
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-20 group-hover:opacity-40 transition-opacity pointer-events-none">
                  {card.icon}
                </div>
              )}
            </>
